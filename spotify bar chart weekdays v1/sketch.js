...
function setup() {
    var c = createCanvas(1000, canvasheight);
...
function HBarChart(data, columnName, where, barColour) {
    ...
    barGap = 20
    barHeight = (drawingLeft - drawingRight) / rowCount * 0.1
    ...
    if (where == "jana") {
        ...
        drawingTop = 100 + 2*barHeight
        drawingBottom = width - 100 + 2*barHeight
    }
    ...
    for (var r = 0; r < rowCount; r++) {
        ...
        noStroke()
        fill(barColour)
        rect(y, canvasheight/2, barHeight, w)
        ...
        if (where == "elena") {
            ...
            textSize(10);
            textAlign(CENTER);
            text(table.get(r, "weekday"), -barGap, 0);
        }
        pop()
